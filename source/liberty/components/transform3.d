 ...
 * Source:          $(LINK2 https://github.com/GabyForceQ/LibertyEngine/blob/master/source/liberty/components/transform3.d)
 * Documentation:
 * Coverage:
**/
module liberty.components.transform3;
...
final class Transform3D {
  ...
  **/
   ...
   *
  **/
  this(SceneNode parent, Transform3D Transform3D) {
    this(parent);
    
    worldPosition = Transform3D.worldPosition;
  ...
  **/
  Transform3D setLocalPosition(string op = "=")(float x, float y, float z) pure {
   ...
   * Returns reference to this.
  **/
  Transform3D setLocalPosition(string op = "=")(Vector3F position) pure {
    static if (op == "=")
   ...
   * Returns reference to this.
  **/
	Transform3D setLocalPositionX(string op = "=")(float value) pure {
		static if (op == "=")
   ...
   * Returns reference to this.
  **/
	Transform3D setLocalPositionY(string op = "=")(float value) pure {
		static if (op == "=")
   ...
   * Returns reference to this.
  **/
	Transform3D setLocalPositionZ(string op = "=")(float value) pure {
		static if (op == "=")
  ...
  **/
	Transform3D setWorldPosition(string op = "=", bool force = false)(float x, float y, float z)  {
   ...
   * Returns reference to this.
  **/
	Transform3D setWorldPosition(string op = "=", bool force = false)(Vector3F position)  {
    mixin (forceBody);
   ...
   * Returns reference to this.
  **/
	Transform3D setWorldPositionX(string op = "=", bool force = true)(float value) {
    mixin (forceBody);
   ...
   * Returns reference to this.
  **/
	Transform3D setWorldPositionY(string op = "=", bool force = false)(float value) {
    mixin (forceBody);
   ...
   * Returns reference to this.
  **/
	Transform3D setWorldPositionZ(string op = "=", bool force = false)(float value) {
    mixin (forceBody);
   ...
   * Returns reference to this.
  **/
	Transform3D setRotation(string op = "=")(float angle, float rotX, float rotY, float rotZ) pure {
   ...
   * Returns reference to this.
  **/
	Transform3D setRotation(string op = "=")(float angle, Vector3F rotation) pure {
    static if (op == "=")
   ...
   * Returns reference to this.
  **/
	Transform3D rotatePitch(float angle) pure {
   ...
   * Returns reference to this.
  **/
	Transform3D rotateYaw(float angle) pure {
   ...
   * Returns reference to this.
  **/
	Transform3D rotateRoll(float angle) pure {
   ...
   * Returns reference to this.
  **/
	Transform3D scale(float value) pure {
   ...
   * Returns reference to this.
  **/
	Transform3D scale(float x, float y, float z) pure {
   ...
   * Returns reference to this.
  **/
	Transform3D scale(Vector3F scaling) pure {
   ...
   * Returns reference to this.
  **/
	Transform3D scaleX(float value) pure {
   ...
   * Returns reference to this.
  **/
	Transform3D scaleY(float value) pure {
   ...
   * Returns reference to this.
  **/
	Transform3D scaleZ(float value) pure {
  ...
  **/
   ...
   *
  **/
  Transform3D setPivot(string op = "=")(float x, float y, float z) pure {
   ...
   * Returns reference to this.
  **/
  Transform3D setPivot(string op = "=")(Vector3F pivot) pure {
    static if (op == "=")
   ...
   * Returns reference to this.
  **/
	Transform3D setPivotX(string op = "=")(float value) pure {
    static if (op == "=")
   ...
   * Returns reference to this.
  **/
	Transform3D setPivotY(string op = "=")(float value) pure {
    static if (op == "=")
   ...
   * Returns reference to this.
  **/
	Transform3D setPivotZ(string op = "=")(float value) pure {
    static if (op == "=")
...
private immutable forceBody = q{
  static if (!force)
    if (!parent.isRootObject()) {
      Logger.warning(
        "You are trying to perform Transform3Dation a non-root object (id: " 
        ~ parent.getId() 
        ~ ") in world space.",
