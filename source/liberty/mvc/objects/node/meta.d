 ...
 * Source:          $(LINK2 https://github.com/GabyForceQ/LibertyEngine/blob/master/source/liberty/mvc/objects/node/meta.d, _meta.d)
 * Documentation:
 * Coverage:
**/
...
immutable NodeBody = q{
  this(string id, NodeController parent = Logic.self.getViewport().getActiveScene().getTree()) {
    if (parent is null) {
