...
class CoreShader : Shader {
  ...
  **/
   ...
   *
  **/
  CoreShader loadModelMatrix(Matrix4F matrix) {
    bind();
   ...
   *
  **/
  CoreShader loadViewMatrix(Matrix4F matrix) {
    bind();
   ...
   *
  **/
  CoreShader loadProjectionMatrix(Matrix4F matrix) {
    bind();
   ...
   *
  **/
  CoreShader loadLightPosition(uint index, Vector3F position) {
    bind();
   ...
   *
  **/
  CoreShader loadLightColor(uint index, Vector3F color) {
    bind();
   ...
   *
  **/
  CoreShader loadLightAttenuation(uint index, Vector3F attenuation) {
    bind();
  ...
  **/
   ...
   *
  **/
  CoreShader loadShineDamper(float value) {
    bind();
   ...
   *
  **/
  CoreShader loadReflectivity(float value) {
    bind();
   ...
   *
  **/
  CoreShader loadUseFakeLighting(bool value) {
    bind();
   ...
   *
  **/
  CoreShader loadSkyColor(Vector3F color) {
    bind();
