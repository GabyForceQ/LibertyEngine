 ...
 * Source:          $(LINK2 https://github.com/GabyForceQ/LibertyEngine/blob/master/source/liberty/objects/node.d)
 * Documentation:
 * Coverage:
 *
 * TODO:
...
**/
module liberty.objects.node;

import liberty.components.transform3;
import liberty.logger : Logger;
import liberty.core.engine : CoreEngine;
import liberty.services : IStartable, IUpdatable;
import liberty.scene : Scene;
import liberty.objects.bsp.impl : BSPVolume;
import liberty.objects.camera : Camera;
...
abstract class SceneNode : IStartable, IUpdatable {
  ...
  **/
  this(string id, SceneNode parent) {
    ...
    if (parent is null)
      ...
      transform = new Transform3D(this, parent.getTransform());
  ...
  **/
   ...
   * Returns transform.
  **/
  Transform3D getTransform() pure nothrow {
    return transform;
  }
