...
uniform float useNormalsPointUp;
...
void main() {
    ...
    if (useNormalsPointUp > 0.5f) {
        currNormal = vec3(0.0f, 1.0f, 0.0f);
    }
    pass_surfaceNormal = (transformationMatrix * vec4(currNormal, 0.0f)).xyz;
